...
namespace RssSubApp.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeedCheckId = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserRssFeed", x => new { x.AppUsersId, x.FeedsId });
                    table.ForeignKey(
                        name: "FK_AppUserRssFeed_AspNetUsers_AppUsersId",
                        column: x => x.AppUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserRssFeed_RssFeeds_FeedsId",
                        column: x => x.FeedsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserRssItem", x => new { x.AppUsersId, x.ItemsId });
                    table.ForeignKey(
                        name: "FK_AppUserRssItem_AspNetUsers_AppUsersId",
                        column: x => x.AppUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserRssItem_RssItems_ItemsId",
                        column: x => x.ItemsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserRssFeed_FeedsId",
                table: "AppUserRssFeed",
                column: "FeedsId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserRssItem_ItemsId",
                table: "AppUserRssItem",
                column: "ItemsId");
